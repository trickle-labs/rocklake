...
|---|---|---|
| DuckLake 1.0, Catalog Version 7 (`V1_0`) | v0.63.6 | v0.63.6 |

RockLake v0.63.6 reports independent version domains in `status --output json`:
...
verified no-op. v0.63.6 continues production beta with the documented public
