...
|---|---|---|
| DuckLake 1.0, Catalog Version 7 (`V1_0`) | v0.63.4 | v0.63.4 |

RockLake v0.63.4 reports independent version domains in `status --output json`:
...
verified no-op. v0.63.4 continues production beta with the documented public
