...
|---|---|---|
| DuckLake 1.0, Catalog Version 7 (`V1_0`) | v0.64.0 | v0.64.0 |

RockLake v0.64.0 reports independent version domains in `status --output json`:
...
verified no-op. v0.64.0 continues production beta with the documented public
