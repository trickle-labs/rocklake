...
v0.63.3 validates concurrent local readers without fencing the active writer.
...
RockLake v0.63.3 is a production-beta evidence release distributed as a
...
| **v0.51.5** | Distribution correctness and release repair | Done |
...
| **v0.63.3** | Safe readers and recovery | **Current** |
