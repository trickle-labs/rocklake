...
pub fn volatility_of(name: &str) -> Volatility {
    match name {
        ...
        | "ceil" | "ceiling" | "cos" | "cosh" | "cot" | "degrees" | "exp" | "factorial"
        | "floor" | "gamma" | "gcd" | "greatest" | "isfinite" | "isinf" | "isnan" | "lcm"
        | "least" | "ln" | "log" | "log10" | "log2" | "lgamma" | "mod" | "pi" | "pow" | "power"
        | "radians" | "round" | "sign" | "sin" | "sinh" | "sqrt" | "tan" | "tanh" | "trunc"
        | "truncate" | "even" | "bit_count" => Volatility::Immutable,
        ...
        "date_part" | "datepart" | "date_diff" | "datediff" | "date_trunc" | "datetrunc"
        | "date_add" | "date_sub" | "extract" | "epoch" | "epoch_ms" | "epoch_us" | "epoch_ns"
        | "make_date" | "make_time" | "make_timestamp" | "strftime" | "strptime"
        | "to_timestamp" | "to_date" | "to_time" | "year" | "month" | "day" | "hour" | "minute"
        | "second" | "millisecond" | "microsecond" | "dayname" | "dayofmonth" | "dayofweek"
        | "dayofyear" | "era" | "isodow" | "isoyear" | "julian" | "last_day" | "monthname"
        | "quarter" | "timezone" | "timezone_hour" | "timezone_minute" | "week" | "weekday"
        | "weekofyear" | "yearweek" => Volatility::Immutable,

        // ── IMMUTABLE: Type cast / conversion ──────────────────────────
        "cast" | "try_cast" | "typeof" | "type_of" | "coalesce" | "ifnull" | "nullif" | "if"
        | "iff" | "case" | "decode" | "encode" | "to_char" | "to_hex" | "from_hex"
        | "to_binary" | "from_binary" | "base64" | "from_base64" => Volatility::Immutable,
        ...
        | "less_than_or_equal"
        | "greater_than"
        | "greater_than_or_equal" => Volatility::Immutable,

        // ── IMMUTABLE: List/Array functions ────────────────────────────
        "array_length" | "array_extract" | "array_slice" | "array_pop_back" | "array_pop_front"
        | "array_push_back" | "array_push_front" | "array_contains" | "array_position"
        | "array_append" | "array_prepend" | "array_cat" | "array_reverse" | "array_sort"
        | "array_distinct" | "array_unique" | "array_to_string" | "list_value" | "list_element"
        | "list_extract" | "list_slice" | "list_contains" | "list_position" | "list_sort"
        | "list_reverse_sort" | "list_distinct" | "list_unique" | "list_cat" | "list_append"
        | "list_prepend" | "list_aggregate" | "list_filter" | "list_transform" | "list_reduce"
        | "list_any_value" | "flatten" | "unnest" | "generate_series" | "range" => {
            Volatility::Immutable
        }

        // ── IMMUTABLE: Map/Struct functions ────────────────────────────
        "map" | "map_from_entries" | "map_entries" | "map_keys" | "map_values" | "map_extract"
        | "map_contains" | "struct_pack" | "struct_extract" | "struct_insert" | "row" => {
            Volatility::Immutable
        }
        ...
        | "get_bit" | "set_bit" => Volatility::Immutable,

        // ── IMMUTABLE: Hashing / crypto ────────────────────────────────
        "sha1" | "sha256" | "sha224" | "sha384" | "sha512" | "crc32" => Volatility::Immutable,

        // ── IMMUTABLE: Misc scalar functions ───────────────────────────
        "alias" | "current_query" | "error" | "rowid" | "pg_typeof" | "oid" | "txid_current"
        | "constant_or_null" | "stats" | "format_bytes" | "bar" => Volatility::Immutable,
