...
fn help_v0514_primary_commands() {
    for args in [
        ...
        ["catalog", "jobs", "--help"].as_slice(),
        ["catalog", "jobs", "list", "--help"].as_slice(),
        ["catalog", "jobs", "status", "--help"].as_slice(),
        ["catalog", "jobs", "cancel", "--help"].as_slice(),
        ["catalog", "jobs", "resume", "--help"].as_slice(),
        ["debug", "--help"].as_slice(),
