//! Streaming ingest: SlateDuckSink and exactly-once delivery semantics.
//!
//! # Overview
//!
//! `SlateDuckSink` is the DuckLake-native streaming ingest endpoint.  It
...
/// Result of a `SlateDuckSink::ingest_batch` call.
#[derive(Debug, Clone)]
...
///
/// ```
/// use slateduck_catalog::SlateDuckSink;
/// let sink = SlateDuckSink::new("pg_tide.orders-to-lake.offset").unwrap();
