...
async fn partitioned_writer_open_multiple_datasets() {
    ...
    let r1 = ds1_ref.read_at(SnapshotId::new(1));
    ...
    let r2 = ds2_ref.read_at(SnapshotId::new(1));
...
async fn partitioned_writer_concurrent_independent_writes() {
    ...
    let rx = ds_x_read.read_at(SnapshotId::new(1));
    ...
    let ry = ds_y_read.read_at(SnapshotId::new(1));
