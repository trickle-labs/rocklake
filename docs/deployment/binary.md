...
[v0.57.0 GitHub release](https://github.com/trickle-labs/rocklake/releases/tag/v0.57.0):

=== "Linux (x86_64)"

    ```bash
    curl -LO https://github.com/trickle-labs/rocklake/releases/download/v0.57.0/rocklake-linux-x86_64
    curl -LO https://github.com/trickle-labs/rocklake/releases/download/v0.57.0/rocklake-linux-x86_64.sha256
...
=== "Linux (ARM64 / aarch64)"
    ...
    ```bash
    curl -LO https://github.com/trickle-labs/rocklake/releases/download/v0.57.0/rocklake-linux-aarch64
    curl -LO https://github.com/trickle-labs/rocklake/releases/download/v0.57.0/rocklake-linux-aarch64.sha256
...
=== "macOS (Apple Silicon)"
    ...
    ```bash
    curl -LO https://github.com/trickle-labs/rocklake/releases/download/v0.57.0/rocklake-macos-arm64
    curl -LO https://github.com/trickle-labs/rocklake/releases/download/v0.57.0/rocklake-macos-arm64.sha256
...
=== "Windows (x86-64)"
    ...
    ```powershell
    Invoke-WebRequest -Uri "https://github.com/trickle-labs/rocklake/releases/download/v0.57.0/rocklake-windows-x86_64.exe" -OutFile rocklake.exe
    Invoke-WebRequest -Uri "https://github.com/trickle-labs/rocklake/releases/download/v0.57.0/rocklake-windows-x86_64.exe.sha256" -OutFile rocklake-windows-x86_64.exe.sha256
...
- Docker images are not published or supported in v0.57.0.
