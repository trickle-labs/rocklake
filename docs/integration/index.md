...
RockLake v0.50.0 supports the following integration paths:
...
- **[Native Extension](native-extension.md)** — Why the experimental wrapper is not a supported v0.50.0 deployment path.
