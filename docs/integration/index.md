...
RockLake v0.51.1 supports the following integration paths:
...
- **[Native Extension](native-extension.md)** — Why the experimental wrapper is not a supported v0.51.1 deployment path.
