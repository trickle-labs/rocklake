...
| Review beta evidence | Continuous during v0.63.x | None | [Production Beta Support](beta-support.md) |
...
- **[Production Beta Support](beta-support.md)** — v0.63.1 support boundaries, escalation route, severity definitions, and the linked evidence ledger.
