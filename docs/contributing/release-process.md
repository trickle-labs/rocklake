...
Releases are prepared from the tagged source commit. For v0.58.0, the
...
maintenance tests cover recovery metadata and bounded scheduling.
...
tests: v0.58.0 supports the binary, DuckLake 1.0 targets covered by CI, local
