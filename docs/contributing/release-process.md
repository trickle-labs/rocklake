...
Releases are prepared from the tagged source commit. For v0.63.2, the
...
checks cover the compatibility freeze. The v0.63.2 gate validates the public
...
tests: v0.63.2 supports the binary, DuckLake 1.0 targets covered by CI, the
