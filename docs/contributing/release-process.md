...
Releases are prepared from the tagged source commit. For v0.60.0, the
...
checks cover the compatibility freeze.
...
tests: v0.60.0 supports the binary, DuckLake 1.0 targets covered by CI, local
