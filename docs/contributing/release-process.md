...
Releases are prepared from the tagged source commit. For v0.63.7, the
...
checks cover the compatibility freeze. The v0.63.7 gate validates the public
surface manifest, beta support policy, evidence ledger, redacted support
bundle, candidate-specific LocalFS evidence, and release artifact contract.
...
tests: v0.63.7 supports the binary, DuckLake 1.0 targets covered by CI, the
