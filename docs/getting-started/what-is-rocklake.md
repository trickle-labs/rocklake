...
bindings for Rust, Python, Go, and Node.js. The v0.49.0 bindings are built from
...
The experimental native DuckDB extension wrapper is not a v0.49.0 deployment
