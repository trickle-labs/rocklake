...
v0.63.5 keeps this storage format unchanged and separates it from the other
...
The v0.63.5 registry contains only a verified same-format no-op. Applying a future
