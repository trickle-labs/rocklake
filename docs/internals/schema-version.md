...
v0.63.6 keeps this storage format unchanged and separates it from the other
...
The v0.63.6 registry contains only a verified same-format no-op. Applying a future
