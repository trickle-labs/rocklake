...
v0.64.0 keeps this storage format unchanged and separates it from the other
...
The v0.64.0 registry contains only a verified same-format no-op. Applying a future
