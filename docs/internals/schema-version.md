...
v0.63.4 keeps this storage format unchanged and separates it from the other
...
The v0.63.4 registry contains only a verified same-format no-op. Applying a future
